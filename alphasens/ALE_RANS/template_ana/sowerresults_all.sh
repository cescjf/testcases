...
for item in DensitySensitivity DisplacementSensitivity EddyViscositySensitivity MachSensitivity NuTildeSensitivity StateVectorSensitivity TemperatureSensitivity TotalPressureSensitivity VelocityNormSensitivity VelocitySensitivity; do
