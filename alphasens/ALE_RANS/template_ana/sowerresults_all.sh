...
for item in DensitySensitivity MeshdispSensitivity EddyViscositySensitivity MachSensitivity NuTildeSensitivity StateVectorSensitivity TemperatureSensitivity TotalPressureSensitivity VelocityNormSensitivity VelocitySensitivity; do
