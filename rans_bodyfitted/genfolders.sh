...
do
  ...
  do
    ...
    do
      ...
      sed -i "s/<perturb_abs1>/$i/g" ./sim_${index_mach}_${index_angle}_${index_perturb}/sdesign/naca_plus.sdesign
      sed -i "s/<perturb_abs1>/$i/g" ./sim_${index_mach}_${index_angle}_${index_perturb}/sdesign/naca_minus.sdesign
